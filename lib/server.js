...
export const markdownToHTML = markdownText => new Promise((resolve, reject) => {
	let result
...
export const getFile = path => new Promise((resolve, reject) => {
...
const createRequestHandler = flags => {
	...
	return (req, res) => {
		let decodedUrl = getPathFromUrl(decodeURIComponent(req.originalUrl))
